    ...
    <header class="bg-white text-gray-800 shadow-md">
      <nav class="container mx-auto flex items-center justify-between py-2 px-14">
        ...
        <ul class="flex space-x-4">
          ...
          <li><a href="#vehicles" class="hover:text-gray-500">Vehicles</a></li>
          <li><a href="#dealers" class="hover:text-gray-500">Dealers</a></li>
          <li><a href="#packages" class="hover:text-gray-500">Packages</a></li>
          <li><a href="#blog" class="hover:text-gray-500">Blog</a></li>
