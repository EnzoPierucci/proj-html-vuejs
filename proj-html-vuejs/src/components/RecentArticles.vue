  ...
  data() {
    return {
      articles: [
        {
          id: 1,
          title: 'Why is BMW so loved?',
          summary: 'An insight into what makes  a great choice for car enthusiasts.',
          image: 'src/assets/Articles/news-autocar-1.jpg',
        },
        {
          id: 2,
          title: 'Why is Audi so loved?',
          summary: 'An insight into what makes  a great choice for car enthusiasts.',
          image: 'src/assets/Articles/news-autocar-2.jpg',
        },
        {
          id: 3,
          title: 'Why is Toyota so loved?',
          summary: 'An insight into what makes a great choice for car enthusiasts.',
          image: 'src/assets/Articles/news-autocar-5.jpg',
        },
        {
          id: 4,
          title: 'Why is Skoda so loved?',
          summary: 'An insight into what makes  a great choice for car enthusiasts.',
          image: 'src/assets/Articles/news-autocar-6.jpg',
        },
